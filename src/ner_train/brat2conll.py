...
def brat_to_conll(input_folder, output_filepath, tokenizer, language='en'):
    '''
...
def main():
    input_folder = 'data/'
    output_filepath = 'output/pico_conll.tsv'
    tokenizer = 'spacy'
    language = 'en'
    brat_to_conll(input_folder, output_filepath, tokenizer, language)
